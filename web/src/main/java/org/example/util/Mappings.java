...
public final class Mappings {
    ...
    public static final String EDIT_ALBUM_ALBUM_ID_UPDATE_DATA = EDIT_ALBUM + ALBUM_ID + UPDATE_DATA;
    public static final String EDIT_ALBUM_ALBUM_ID_UPDATE_PHOTO = EDIT_ALBUM + ALBUM_ID + UPDATE_PHOTO;
